<template>
  <a-card title="节点配置（HTTP 映射隧道）">
    <a-form layout="vertical">
      ...
      <a-form-item label="编码（20 位国标编码）"><a-input v-model:value="draft.local_node.device_id" class="gb-code-input" maxlength="20" /></a-form-item>
      ...
      <a-form-item label="本地映射起始端口"><a-input-number v-model:value="draft.local_node.mapping_port_start" :min="1" :max="65535" style="width: 100%" /></a-form-item>
      <a-form-item label="本地映射结束端口"><a-input-number v-model:value="draft.local_node.mapping_port_end" :min="1" :max="65535" style="width: 100%" /></a-form-item>
      ...
      <a-form-item label="编码（20 位国标编码）"><a-input v-model:value="draft.peer_node.device_id" class="gb-code-input" maxlength="20" /></a-form-item>
    </a-form>
    <a-space>
...
const draft = reactive<NodeConfigPayload>({
  local_node: { node_ip: '', signaling_port: 5060, device_id: '', rtp_port_start: 20000, rtp_port_end: 20999, mapping_port_start: 18100, mapping_port_end: 18999 },
