  ...
  <a-space direction="vertical" size="middle" style="width: 100%">
    <a-card title="本端节点配置">
      ...
      <a-form layout="vertical">
        ...
        <a-divider orientation="left">本地映射端口范围</a-divider>
        <a-form-item label="本地映射起始端口"><a-input-number v-model:value="draft.mapping_port_start" :min="1" :max="65535" style="width: 100%" /></a-form-item>
        <a-form-item label="本地映射结束端口"><a-input-number v-model:value="draft.mapping_port_end" :min="1" :max="65535" style="width: 100%" /></a-form-item>
      </a-form>
      <a-space>
