...
func Catalog() []ParamMeta {
	return []ParamMeta{
		...
		{Name: "network.sip.tcp_read_buffer_bytes", Type: "int", Default: 65536, HotReload: true, Risk: RiskMedium, Description: "SIP TCP 连接读缓冲区大小。", NetworkKey: true},
		{Name: "network.sip.tcp_write_buffer_bytes", Type: "int", Default: 65536, HotReload: true, Risk: RiskMedium, Description: "SIP TCP 连接写缓冲区大小。", NetworkKey: true},
		{Name: "network.sip.max_connections", Type: "int", Default: 2048, HotReload: true, Risk: RiskHigh, Description: "SIP TCP 最大并发连接数。", NetworkKey: true},
