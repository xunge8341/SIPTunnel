...
- 隧道配置 API：`GET /api/tunnel/config`、`POST /api/tunnel/config`
  - 配置以 GB/T 28181 注册与心跳为核心：`channel_protocol`、`connection_initiator`、`local_device_id`、`peer_device_id`、`heartbeat_interval_sec`、`register_retry_count`、`register_retry_interval_sec`。
